...
PwmOutAdvancedTimer::PwmOutAdvancedTimer(void)
{
    ...
    // auto_reload_reg = 3599 gives a timer frequency of 20kHz for edge aligned
    // auto_reload_reg = 1799 gives a of 20kHz for center aligned

    uint16_t prescalar = 0;
    auto_reload_reg_ =  1799;
    ...
    // GPIO Configuration: TIM1 CH1 (PA8), CH2 (PA9), CH3 (PA10)
